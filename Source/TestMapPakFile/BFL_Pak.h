...
UCLASS()
class UBFL_Pak : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "PAK")
	static bool MountPakFile(FString PakFilePath, const FString& PakMountPoint);
	...
	static FString GetPakMountPoint(const FString& PakFilePath);
